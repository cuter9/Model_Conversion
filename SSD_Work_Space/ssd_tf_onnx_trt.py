...
WORK = os.getcwd()
ONNX_WORK_SPACE = os.path.join(WORK, "ONNX_Model")
MODEL_REP_DIR = os.path.join(ONNX_WORK_SPACE, "Repo")

TMP_PB_GRAPH_NAME = MODEL_NAME + "_4_onnx_conv.pb"

TF_MODEL_DIR = os.path.join(WORK, "TF_Model")
...
def redef_onnx_node_4_trt_plugin_1(path_onnx_model, path_onnx_model_new):
    ...
    # path_onnx_model_new = os.path.join(MODEL_REP_DIR, MODEL_NAME + "_new.onnx")
...
if __name__ == '__main__':
    ...
    output_engine = os.path.join(MODEL_REP_DIR, MODEL_TRT + ".engine")

    path_graph_pb = os.path.join(MODEL_REP_DIR, TMP_PB_GRAPH_NAME)
    path_onnx_model = os.path.join(MODEL_REP_DIR, MODEL_NAME + ".onnx")
    path_onnx_model_1 = os.path.join(MODEL_REP_DIR, MODEL_NAME + "_1.onnx")
    ...
    path_onnx_model_new_1 = os.path.join(MODEL_REP_DIR, MODEL_NAME + "_1_new.onnx")
