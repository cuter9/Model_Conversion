...
def open_cam_onboard(width, height):
    ...
    gst_str = ('nvarguscamerasrc sensor_mode=2 ! nvvidconv flip-method=0 ! '
    'video/x-raw, width=(int){}, height=(int){}, format=(string)BGRx ! '
    'videoconvert ! appsink').format(width, height)
    # gst_str = "nvarguscamerasrc sensor_mode=2 ! nvvidconv flip-method=0 ! video/x-raw,width=960, height=616  ! nvvidconv ! appsink"
    # else:
