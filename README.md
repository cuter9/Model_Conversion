...
4. Important Note:
   ...
   > b. There is a bug in "crosstool_wrapper_driver_is_not_gcc.tpl". In the line 206 of the tpl file, there are only 2 arguments but 3 "capability" data are provided, one of which should be deleted.
