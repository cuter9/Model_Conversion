...
if [ ! -f "yolo_v7.onnx" ]; then
  # python3 export.py --weights ./yolo_v7.pt --grid --end2end --dynamic-batch --simplify --topk-all 100 --iou-thres 0.65 --conf-thres 0.01 --img-size 640 640
  # python3 export.py --weights ./yolo_v7.pt --grid --simplify --include-nms
  python3 export.py --weights ./yolo_v7.pt --grid --end2end  --simplify --topk-all 100 --iou-thres 0.65 --conf-thres 0.35 --img-size 640 640
fi
...
if [ ! -f "yolo_v7-tiny.onnx" ]; then
  # python3 export.py --weights ./yolo_v7-tiny.pt --grid --end2end --dynamic-batch --simplify --topk-all 100 --iou-thres 0.65 --conf-thres 0.01 --img-size 640 640
  # python3 export.py --weights ./yolo_v7-tiny.pt --grid --simplify --include-nms
  python3 export.py --weights ./yolo_v7-tiny.pt --grid --end2end  --simplify --topk-all 100 --iou-thres 0.65 --conf-thres 0.35 --img-size 640 640
fi
# shellcheck disable=SC2016
